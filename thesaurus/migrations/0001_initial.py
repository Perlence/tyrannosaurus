    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consists_of', models.ManyToManyField(related_name='consists_of_rel_+', to='thesaurus.Descriptor', blank=True)),
                ('higher_level_descriptors', models.ManyToManyField(related_name='higher_level_descriptors_rel_+', to='thesaurus.Descriptor', blank=True)),
